            ...
            <div className="bg-[#4793E7] w-full md:w-3/4 lg:w-1/3 mx-auto p-10 ">
                ...
                <form className="">
                    ...
                    <div className="form-control mt-6">
                        <button  className=" py-2 rounded-md bg-[#017BFF] text-white">Sign In</button>
                    </div>
                    <div>
                        <button  className="flex justify-center items-center mx-auto mt-10 bg-white rounded-full px-8 py-4">
